...
public class StudentCourseTemplate {
    ...
    public static BorderPane getStudentCourseDetailsView(String studentEmailId, String courseId) {
        ...
        sc.setMaxHeight(main.window.getHeight() / 2);
        main.window.heightProperty().addListener(e -> sc.setMaxHeight(main.window.getHeight() / 2));
        ...
        sc1.setMaxHeight(main.window.getHeight() / 2);
        main.window.heightProperty().addListener(e -> sc1.setMaxHeight(main.window.getHeight() / 2));


        assignmentAnnouncementContainer.getChildren().addAll(sc, sc1);
        sc.setMaxWidth(Double.MAX_VALUE);
        sc1.setMaxWidth(Double.MAX_VALUE);
        HBox.setHgrow(sc, Priority.ALWAYS);
        HBox.setHgrow(sc1, Priority.ALWAYS);
